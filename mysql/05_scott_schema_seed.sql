-- SCOTT-style DEPT/EMP schema and self join practice
-- Source: MySQL.txt demo_scott section

CREATE DATABASE IF NOT EXISTS scott_demo;
USE scott_demo;
